...
#ifndef SANDBOX_PROJECT2_H
#define SANDBOX_PROJECT2_H
...
namespace Sandbox {
    ...
    class SceneProject2 : public Scene {
        public:
            SceneProject2(int width, int height);
            ~SceneProject2() override;
