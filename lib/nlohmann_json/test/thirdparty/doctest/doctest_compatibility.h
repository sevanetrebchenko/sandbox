...
// included here because for some tests in the nlohmann_json repository private is defined as
// public and if no STL header is included before that then in the nlohmann_json include when STL
