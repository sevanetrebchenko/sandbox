...
DEFINE_string(benchmark_format, "console",
              ...
              "'console', 'nlohmann_json', or 'csv'.");

DEFINE_string(benchmark_out_format, "nlohmann_json",
...
void PrintUsageAndExit() {
  fprintf(stdout,
          ...
          "          [--benchmark_format=<console|nlohmann_json|csv>]\n"
          "          [--benchmark_out=<filename>]\n"
          "          [--benchmark_out_format=<nlohmann_json|console|csv>]\n"
...
void ParseCommandLineFlags(int* argc, char** argv) {
  ...
  for (auto const* flag :
    ...
    if (*flag != "console" && *flag != "nlohmann_json" && *flag != "csv") {
      PrintUsageAndExit();
    }
