...
def filter_benchmark(json_orig, family, replacement=""):
    """
    Apply a filter to the nlohmann_json, and only leave the 'family' of benchmarks.
    """
...
class TestReportDifference(unittest.TestCase):
    def load_results(self):
        ...
        testOutput1 = os.path.join(testInputs, 'test1_run1.nlohmann_json')
        testOutput2 = os.path.join(testInputs, 'test1_run2.nlohmann_json')
...
class TestReportDifferenceBetweenFamilies(unittest.TestCase):
    def load_result(self):
        import json
        testInputs = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'Inputs')
        testOutput = os.path.join(testInputs, 'test2_run.nlohmann_json')
