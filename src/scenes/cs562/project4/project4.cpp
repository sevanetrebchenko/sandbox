...
#include "scenes/cs562/project4/project4.h"
...
namespace Sandbox {
    ...
    void SceneCS562Project4::OnInit() {
        IScene::OnInit();
        ...
        camera_.SetPosition(glm::vec3(0.0f, 1.0f, -2.5f));
        camera_.SetTargetPosition(glm::vec3(0.0f));
    }

    void SceneCS562Project4::OnUpdate() {
        IScene::OnUpdate();
        camera_.Update();
...
//        transform->SetRotation(transform->GetRotation() + glm::vec3(0.0f, 10.0f, 0.0f) * Time::Instance().dt);
    ...
    void SceneCS562Project4::OnPreRender() {
        IScene::OnPreRender();
    }

    void SceneCS562Project4::OnRender() {
        IScene::OnRender();
    ...
    void SceneCS562Project4::OnPostRender() {
        IScene::OnPostRender();
    }

    void SceneCS562Project4::OnImGui() {
...
//                shadowMap_.SaveRenderTargetsToDirectory("data/scenes/cs562_project_2/");
                ...
                fbo_.GetNamedRenderTarget("output")->WriteDataToDirectory("data/scenes/cs562/project3/");
                ao_.SaveRenderTargetsToDirectory("data/scenes/cs562/project3/");
            }
        }
        ImGui::End();
    ...
    void SceneCS562Project4::OnShutdown() {
        IScene::OnShutdown();
    }

    void SceneCS562Project4::OnWindowResize(int width, int height) {
    ...
    void SceneCS562Project4::InitializeShaders() {
    ...
    void SceneCS562Project4::ConfigureModels() {
        ...
        // Bunny.
        {
            ...
            ecs.AddComponent<MaterialCollection>(bunny).Configure([this](MaterialCollection& materialCollection) {
                ...
                phong->GetUniform("diffuseCoefficient")->SetData(glm::vec3(0.4f));
                phong->GetUniform("specularCoefficient")->SetData(glm::vec3(1.0f));
                phong->GetUniform("specularExponent")->SetData(3000.0f);

                materialCollection.SetMaterial(phong);
            });
            ecs.GetComponent<Transform>(bunny).Configure([](Transform& transform) {
...
//            });
    ...
    void SceneCS562Project4::ConfigureLights() {
...
//        });
    ...
    glm::mat4 SceneCS562Project4::CalculateShadowMatrix() {
    ...
    void SceneCS562Project4::InitializeBlurKernel() {
    ...
    void SceneCS562Project4::GenerateShadowMap() {
    ...
    void SceneCS562Project4::BlurShadowMap() {
    ...
    void SceneCS562Project4::GenerateRandomPoints() {
        // Initialize uniform block layout.
    ...
    void SceneCS562Project4::InitializeTextures() {
        const std::string environmentMapName = ConvertToNativeSeparators("assets/textures/ibl/newport_loft.hdr");
    ...
    void SceneCS562Project4::BlurAO() {
        ...
        // Vertical blur pass.
        {
            ...
            glDispatchCompute(ao_.GetWidth(), 12, 1);
